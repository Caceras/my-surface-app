...
6. Update affected guides in the same implementation batch. Run `python tools/check.py`. Avoid repeated documentation-only Android rebuilds by finishing prose and links before the final source push when practical.
